  ...
  const validatePassword = (password) => {
    if (password) {
      if (
        ...
        setPasswordError(
          "password should contain atleast 1 special,Capital,number "
        );
        return false;
      }
    } else {
  ...
  return (
    <div>
      <div className="container">
          ...
          <div className="card border-primary border-2 rounded-top">
                ...
                <div className="row mt-3">
                  <div className="col-md-6">
                    <input
                      ...
                      name="term"
                      onChange={(event) => {
                        updateUserDetailsWithTerms(event);
                      }}
                    />
